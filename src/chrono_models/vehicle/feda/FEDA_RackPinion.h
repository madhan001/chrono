...
#ifndef FEDA_RACKPINION_H
#define FEDA_RACKPINION_H
...
/// Rack-pinion steering subsystem for the FEDA vehicle.
class CH_MODELS_API FEDA_RackPinion : public ChRackPinion {
  public:
    FEDA_RackPinion(const std::string& name);
    ~FEDA_RackPinion() {}
