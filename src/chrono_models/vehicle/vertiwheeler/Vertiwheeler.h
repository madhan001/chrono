...
// =============================================================================
//
// Wrapper classes for modeling an entire Vertiwheeler vehicle assembly
// (including the vehicle itself, the powertrain, and the tires).
//
// =============================================================================

#ifndef VERTIWHEELER_H
#define VERTIWHEELER_H
...
/// Definition of the Vertiwheeler assembly.
...
class CH_MODELS_API Vertiwheeler {
  public:
    Vertiwheeler();
    Vertiwheeler(ChSystem* system);
  ...
  protected:
    ...
    ChSystem* m_system;
    Vertiwheeler_Vehicle* m_vehicle;
