...
#ifndef VERTIWHEELER_TMEASY_TIRE_H
#define VERTIWHEELER_TMEASY_TIRE_H
...
/// TMeasy tire model for the Vertiwheeler.
class CH_MODELS_API Vertiwheeler_TMeasyTire : public ChTMeasyTire {
  public:
    Vertiwheeler_TMeasyTire(const std::string& name);
    ~Vertiwheeler_TMeasyTire() {}
