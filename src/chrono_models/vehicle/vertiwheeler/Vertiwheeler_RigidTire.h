...
#ifndef VWMEDIUM_RIGID_TIRE_H
#define VWMEDIUM_RIGID_TIRE_H
...
/// Rigid tire model for the Vertiwheeler vehicle.
class CH_MODELS_API Vertiwheeler_RigidTire : public chrono::vehicle::ChRigidTire {
  public:
    Vertiwheeler_RigidTire(const std::string& name, bool use_mesh = false);
    ~Vertiwheeler_RigidTire() {}
