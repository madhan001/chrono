...
#ifndef VWMEDIUM_CHASSIS_H
#define VWMEDIUM_CHASSIS_H
...
/// Vertiwheeler chassis subsystem.
class CH_MODELS_API Vertiwheeler_Chassis : public chrono::vehicle::ChRigidChassis {
  public:
    Vertiwheeler_Chassis(const std::string& name,
                  bool fixed = false,
                  CollisionType chassis_collision_type = CollisionType::NONE);
    ~Vertiwheeler_Chassis() {}
