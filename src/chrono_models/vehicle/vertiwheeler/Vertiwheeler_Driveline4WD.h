...
#ifndef VWMEDIUM_DRIVELINE_4WD_H
#define VWMEDIUM_DRIVELINE_4WD_H
...
/// Shafts-based 4-WD driveline for the Vertiwheeler vehicle.
class CH_MODELS_API Vertiwheeler_Driveline4WD : public ChShaftsDriveline4WD {
  public:
    Vertiwheeler_Driveline4WD(const std::string& name);
    ~Vertiwheeler_Driveline4WD() {}
